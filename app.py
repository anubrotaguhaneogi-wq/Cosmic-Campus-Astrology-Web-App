...
TOPIC_MAP = [
    (["বিয়ে", "বিবাহ", "সম্পর্ক", "প্রেম", "স্বামী", "স্ত্রী"], "💍 বিবাহ ও সম্পর্ক", ["শুক্র", "বৃহস্পতি", "মঙ্গল"], "বিবাহের জন্য শুক্র, বৃহস্পতি ও মঙ্গলের অবস্থান দেখা হয়।"),
    (["ক্যারিয়ার", "চাকরি", "কাজ", "পেশা", "ব্যবসা"], "💼 ক্যারিয়ার ও পেশা", ["শনি", "সূর্য", "বুধ"], "পেশার জন্য শনি (কর্ম), সূর্য (মর্যাদা) ও বুধ (বুদ্ধি) দেখা হয়।"),
    (["টাকা", "অর্থ", "ধন", "আয়", "সম্পদ", "বেতন"], "💰 অর্থ ও সম্পদ", ["বৃহস্পতি", "শুক্র", "বুধ"], "অর্থের জন্য বৃহস্পতি (ধন), শুক্র (স্বাচ্ছন্দ্য) ও বুধ (বাণিজ্য) দেখা হয়।"),
    (["স্বাস্থ্য", "রোগ", "অসুখ", "শরীর"], "🩺 স্বাস্থ্য", ["সূর্য", "চন্দ্র", "মঙ্গল", "শনি"], "স্বাস্থ্যের জন্য সূর্য (প্রাণশক্তি), চন্দ্র (মন), মঙ্গল ও শনি দেখা হয়।"),
    (["শিক্ষা", "পড়াশোনা", "পরীক্ষা", "বিদ্যা"], "📚 শিক্ষা", ["বুধ", "বৃহস্পতি"], "শিক্ষার জন্য বুধ (বুদ্ধি) ও বৃহস্পতি (জ্ঞান) দেখা হয়।"),
    (["সন্তান", "ছেলে", "মেয়ে", "বাচ্চা"], "👶 সন্তান", ["বৃহস্পতি", "চন্দ্র"], "সন্তানের জন্য বৃহস্পতি (পুত্রকারক) ও চন্দ্র দেখা হয়।"),
    (["ভ্রমণ", "বিদেশ", "যাত্রা", "ট্যুর"], "✈️ ভ্রমণ ও বিদেশ", ["রাহু", "চন্দ্র", "শনি"], "ভ্রমণের জন্য রাহু (বিদেশ), চন্দ্র ও শনি দেখা হয়।"),
    (["দশা", "মহাদশা", "সময়"], "⏳ দশা বিশ্লেষণ", ["চন্দ্র", "সূর্য"], "দশার প্রভাব বুঝতে চন্দ্র নক্ষত্রের অধিপতি ও চলমান মহাদশা দেখা হয়।"),
]
...
def generate_reply(user_prompt, chart, user_name, gender):
    ...
    topic_title = "🔮 সাধারণ বিশ্লেষণ"
    topic_planets = ["সূর্য", "চন্দ্র"]
    topic_note = "আপনার চার্টের সাধারণ চিত্র নিচে দেওয়া হলো।"
    for keywords, title, planets, note in TOPIC_MAP:
        if any(k in user_prompt for k in keywords):
            topic_title, topic_planets, topic_note = title, planets, note
            break

    planet_notes = house_lord_note(chart, topic_planets)

    return f"""### {topic_title}

**প্রিয় {user_name} ({gender}),** আপনার প্রশ্ন: _{user_prompt}_

{topic_note}

- **লগ্ন:** {lagna}
- **চন্দ্র নক্ষত্র:** {moon_nak}
- **বর্তমান মহাদশা:** {current_dasha}
- **প্রাসঙ্গিক গ্রহ:** {planet_notes}

**স্বভাব:** {char}

_এটি সাধারণ বৈদিক নিয়মভিত্তিক ইঙ্গিত। বিস্তারিত বিচারের জন্য অভিজ্ঞ জ্যোতিষীর পরামর্শ নিন।_"""


# ================= Chat Input & Execution =================
user_name = st.session_state.get("name", "ব্যবহারকারী")
