...
# ==================== গণনার ফাংশন ====================
def calculate_chart(
    dob: date, tob: dtime, lat: float, lon: float, tz: float = IST_OFFSET
):
...
def ask_ai(question: str, chart: dict, birth_info: str) -> str:
  ...
  try:
    ...
    return (
        "⚠ API key পাওয়া যায়নি। Streamlit Secrets-এ GROQ_API_KEY যোগ করুন।"
    )
  ...
  system_prompt = (
      ...
      "সবসময় সহজ বাংলায় উত্তর দাও। নিচের জন্মছকের তথ্য ব্যবহার করে ব্যবহারকারীর"
      " প্রশ্নের উত্তর দাও। "
